    ...
    <div class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true" x-show="open" x-cloak>
      ...
      <div class="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
        <div class="px-4 pt-5 pb-2 flex">
          <button  @click="open = ! open" type="button" class="-m-2 p-2 rounded-md inline-flex items-center justify-center text-gray-400">
        ...
        <div class="mt-2">
          <div class="border-b border-gray-200" >
            <div class="-mb-px flex px-4 space-x-8" aria-orientation="horizontal" role="tablist">
              ...
              <button @click="megamenu = ! megamenu" id="tabs-1-tab-1" class="text-gray-900 border-transparent flex-1 whitespace-nowrap py-4 px-1 border-b-2 text-base font-medium" aria-controls="tabs-1-panel-1" role="tab" type="button">Women</button>

              <!-- Selected: "text-indigo-600 border-indigo-600", Not Selected: "text-gray-900 border-transparent" -->
              <button @click="megamenu = ! megamenu" id="tabs-1-tab-2" class="text-gray-900 border-transparent flex-1 whitespace-nowrap py-4 px-1 border-b-2 text-base font-medium" aria-controls="tabs-1-panel-2" role="tab" type="button">Men</button>
            </div>
          </div>

          <!-- 'Women' tab panel, show/hide based on tab state. -->
          <div id="tabs-1-panel-1" class="px-4 pt-10 pb-6 space-y-12" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0" x-show="megamenu" x-cloak>
                    ...
                    <div class="h-full flex justify-center space-x-8">
                      <div class="flex">
                        <div class="relative flex">
                          ...
                          <button @mouseover="women = ! women" @click="women = ! women" type="button" x-state:on="Item active" x-state:off="Item inactive"
                          class="border-transparent text-gray-700 hover:text-gray-600 relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px" aria-expanded="false"
                        ...
                        <!--
                          ...
                          Leaving: "transition ease-in duration-150"
                            ...
                            To: "opacity-0"
                        -->
                        <div class="absolute top-full inset-x-0 text-gray-500 sm:text-sm" x-show="women" @mouseover.away="women = false" x-cloak>
                      ...
                      <div class="flex">
                        <div class="relative flex">
                          <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                        <button @mouseover="men = ! men" @click="men = ! men" type="button" x-state:on="Item active" x-state:off="Item inactive"
                          class="border-transparent text-gray-700 hover:text-gray-600 relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px" aria-expanded="false"
                        ...
                        <!--
                          ...
                          Leaving: "transition ease-in duration-150"
                            ...
                            To: "opacity-0"
                        -->
                        <div class="absolute top-full inset-x-0 text-gray-500 sm:text-sm" x-show="men" @mouseover.away="men = false" x-cloak>
                          <!-- Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow -->
                          <div class="absolute inset-0 top-1/2 bg-white shadow" aria-hidden="true"></div>
                      ...
                      <a href="#" class="border-transparent text-gray-700
                      hover:text-gray-600 relative z-10 flex items-center transition-colors ease-out duration-200 text-sm font-medium border-b-2 -mb-px pt-px" aria-expanded="false"
                      :class="{ 'border-indigo-600 text-indigo-600': links, 'border-transparent text-gray-700 hover:text-gray-800': !(links) }"
                       @mouseover="links = ! links" @click="links = ! links" @mouseover.away="links = false"
                      >Company</a>
